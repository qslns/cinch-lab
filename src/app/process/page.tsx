  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-yon-white">
      ...
      <section className="relative min-h-[90vh] flex flex-col justify-center px-6 md:px-12 lg:px-16 overflow-hidden">
        ...
        {/* Background letter */}
        <motion.span
          className="absolute top-[10%] right-[-10%] font-mono text-[50vw] md:text-[40vw] text-yon-platinum/10 leading-none select-none pointer-events-none"
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          {/* Title */}
          <h1 className="font-serif text-[18vw] md:text-[14vw] lg:text-[12vw] text-yon-black leading-[0.85]">
            <motion.span
              className="block"
          ...
          {/* Subtitle */}
          <motion.div
            className="mt-12 md:mt-16 ml-[5%] md:ml-[15%] max-w-lg"
          ...
          >
            <p className="text-xl md:text-2xl text-yon-steel leading-relaxed">
              ...
              Every step documented, every failure celebrated.
            </p>
            <p className="mt-4 text-base text-yon-grey leading-relaxed">
              아이디어에서 의복까지의 여정.
              모든 단계가 기록되고, 모든 실패가 축하받습니다.
            </p>
          </motion.div>

          {/* Stats */}
          <motion.div
            className="mt-16 md:mt-24 grid grid-cols-3 gap-8 max-w-xl"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              ...
              <div key={i}>
                <span className="font-serif text-4xl md:text-5xl text-yon-black">{stat.value}</span>
                <span className="block mt-2 font-mono text-[9px] text-yon-grey tracking-[0.15em] uppercase">
                  {stat.label}
                </span>
              </div>
            ))}
          ...
          {/* Scroll indicator */}
          <motion.div
            className="absolute bottom-[-20vh] left-1/2 -translate-x-1/2 flex flex-col items-center gap-3"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
